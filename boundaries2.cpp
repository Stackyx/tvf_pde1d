...
bound2::bound2(payoff f, mesh grille)
	: b_f(f), b_mesh(grille)
{
	 b_method = "Dirichelet";
...
bound2::bound2(payoff f, mesh grille, std::string method, std::vector<std::vector<double>> conditions)
...
bound2::bound2(payoff f, mesh grille, std::string method)
...
bound2::bound2(payoff f, mesh grille,std::vector<std::vector<double>> conditions)
...
void bound2::get_boundaries2(double ri, double ri1, double sigma0, double sigma1, double T, double dt, double j, std::vector<double>& sol)
{
...
void bound2::get_boundaries_nocdt(double ri, double ri1, double sigma0, double sigma1, double T, double dt, double j, std::vector<double>& sol)
{
...
void bound2::get_boundaries_cdt(double ri, double ri1, double sigma0, double sigma1, double T, double dt, double j, std::vector<double>& sol)
{
